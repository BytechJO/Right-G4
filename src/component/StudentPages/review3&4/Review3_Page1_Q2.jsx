...
const ITEMS = [
  ...
  {
    id:        3,
    scrambled: "the was that part best.",
  ...
  return (
    <div className="main-container-component">
      <style>{`
        ...
        .uswb-input--answer   { color: ${INPUT_ANSWER_COLOR}; }
      ...
      >
        ...
        <div className="uswb-list">
          {ITEMS.map((item) => {
            ...
            return (
              <div key={item.id} className="uswb-item">
