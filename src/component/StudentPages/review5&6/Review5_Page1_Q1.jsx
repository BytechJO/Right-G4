...
//  📝  EXERCISE DATA
// ─────────────────────────────────────────────
const WORD_BANK = ["swimming", "hurts", "flu", "spoiled"];

const ITEMS = [
  {
    id:      1,
    before:  "Janet is sick and in bed with the",
    after:   ".",
    correct: ["flu"],
    answer:  "flu",
  },
  {
    id:      2,
    before:  "We knew the meat was",
    after:   "because of the bad smell.",
    correct: ["spoiled"],
    answer:  "spoiled",
  },
  {
    id:      3,
    before:  "He fell, and so now his knee",
    after:   ".",
    correct: ["hurts"],
    answer:  "hurts",
  },
