...
const ITEMS = [
  {
    id:        1,
    scrambled: "nowhere  in  middle  of  the",
    correct:   ["In the middle of nowhere", "in the middle of nowhere"],
    answer:    "In the middle of nowhere",
  },
  {
    id:        2,
    scrambled: "What  next?  happened",
    correct:   ["What happened next?", "what happened next"],
    answer:    "What happened next?",
  },
  {
    id:        3,
    scrambled: "like  I  them  don't.",
    correct:   ["I don't like them.", "i don't like them", "i dont like them"],
    answer:    "I don't like them.",
  },
  {
    id:        4,
    scrambled: "mostly,  I  was",
    correct:   ["I was mostly,", "i was mostly", "I was mostly"],
    answer:    "I was mostly,",
  },
];
  ...
  return (
    <div className="main-container-component">
      <style>{`
        ...
        .uswb-input--answer   { color: ${INPUT_ANSWER_COLOR}; font-weight: 700; font-size: clamp(15px, 2vw, 24px); }
