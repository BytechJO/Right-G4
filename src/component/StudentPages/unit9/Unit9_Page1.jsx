...
const wordTimingsVoc = [
  { word: "Chores,", start: 8.96, end: 10.22 },
  { word: "video games,", start: 10.22, end: 11.92 },
  { word: "tomorrow,", start: 11.92, end: 14.22 },
  { word: "room,", start: 14.22, end: 14.64 },
  { word: "hour,", start: 14.64, end: 16.04 },
  { word: "call,", start: 17.06, end: 17.56 },
  { word: "bored,", start: 17.56, end: 19.06 },
  { word: "finished,", start: 19.06, end: 21.52 },
  { word: "together.", start: 21.52, end: 22.72 },
  { word: "Can you come over to my house?", start: 22.72, end: 24.42 },
  { word: "No problem.", start: 25.58, end: 26.60 },
  { word: "Oh, well.", start: 27.90, end: 28.46 },
  { word: "Thanks anyway.", start: 29.88, end: 31.00 },
  { word: "What's up?", start: 32.18, end: 32.72 },
  { word: "I'm really sorry.", start: 34.02, end: 35.12 },
];
          ...
          <svg
            ...
            onClick={() =>
              openPopup(
                ...
                <CriticalThinking
                  title={
                    "Why is Tom happy at the end of the story?"
                  }
                />,
              )
            }
