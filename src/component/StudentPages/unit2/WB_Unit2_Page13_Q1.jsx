...
const ACTIVE_BAR = "#d62828";
const CARD_BORDER = "#f29a1f";
const EMPTY_BAR = "#ffffff";
const BAR_BORDER = "#b6b6b6";
...
const styles = {
  ...
  card: {
    position: "relative",
    minHeight: "clamp(150px, 28vw, 250px)",
  ...
  imageWrap: {
    ...
    padding: "clamp(10px, 1.6vw, 18px) clamp(4px, 0.8vw, 8px) 0",
    boxSizing: "border-box",
    minHeight: "clamp(110px, 20vw, 180px)",
  },
  ...
  image: {
    ...
    maxHeight: "clamp(90px, 18vw, 180px)",
    objectFit: "contain",
    display: "block",
    userSelect: "none",
    pointerEvents: "none",
      ...
      <div style={styles.barsWrap}>
        {[1, 2, 3, 4, 5].map((n) => (
          <span
            ...
            style={{
              ...styles.bar,
              background: n <= count ? ACTIVE_BAR : EMPTY_BAR,
            }}
          />
        ))}
      </div>
