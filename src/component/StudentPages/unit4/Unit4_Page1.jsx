...
const wordTimingsVoc = [
  ...
  y1: 27.8,
  x2: 49.8,
  y2: 32,    slice: { startFrom:captions[1].start,  stopAt: captions[1].end 
       },
    },
  ...
  y1: 41,
  x2: 36.1,
  y2: 47,    slice: { startFrom:captions[8].start,  stopAt: captions[8].end  },
    },
    {
  x1: 55.1,
  y1: 23,
  x2: 79.1,
  y2: 26.4,     slice: { startFrom:captions[8].start,  stopAt: captions[8].end  },
    },
    {
   x1: 69.5,
  y1: 42.6,
  ...
  y1: 48.5,
  x2: 40.9,
  y2: 51.37,   slice: { startFrom:captions[5].start,  stopAt: captions[5].end  },
    },
    {
  x1: 19.5,
  y1: 69.5,
  x2: 49.3,
  y2: 73.97,   slice: { startFrom:captions[6].start,  stopAt: captions[6].end  },
    },
    {
  x1: 55.6,
  y1: 49.5,
  x2: 90.1,
  y2: 52.5,   slice: {startFrom:captions[7].start ,  stopAt: captions[7].end  },
    },
    {
  x1: 77.6,
  y1: 69.8,
  x2: 90.8,
  y2: 72.8,    slice: { startFrom:captions[10].start,  stopAt: captions[10].end  },
    },
  ];
